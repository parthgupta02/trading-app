...
import { useData } from '../../trading/context/DataContext';
import { getMondayOfWeek, getFridayOfWeek } from '../../trading/utils/dateUtils';
...
import { OpenPositionsCard } from '../../trading/components/OpenPositionsCard';
